...
<h2>Rブラスターエリートデコの評価と役割</h2>
<table>
<tr>
  <td rowspan="4" colspan="2" style="text-align:center;vertical-align:middle;width:40%">
    <img src="/gamers-for/images/games/splatoon3/weapons/custom-range-blaster.png" alt="Rブラスターエリートデコ" loading="lazy" width="90" height="90" style="display:inline-block"><br>
    <strong style="font-size:1.1em">Rブラスターエリートデコ</strong>
  </td>
...
<tr>
  <td colspan="2" style="text-align:center"><img src="/gamers-for/images/games/splatoon3/subs/toxic-mist.png" alt="ポイズンミスト" loading="lazy" width="24" height="24" style="vertical-align:middle"> ポイズンミスト ／ <img src="/gamers-for/images/games/splatoon3/specials/ink-storm.png" alt="アメフラシ" loading="lazy" width="24" height="24" style="vertical-align:middle"> アメフラシ</td>
</tr>
<tr>
  <th>塗り</th><td>★★☆☆☆</td>
  <th>扱いやすさ</th><td>★★★☆☆</td>
...
<tr><td>
<b>○ ブラスターの爆風で壁裏の敵にもダメージが入る。遮蔽物越しの戦いが超得意</b><hr><b>○ ポイズンミストで相手の動きを鈍くできる。エリア管理や逃げる相手の足止めに有効</b><hr><b>○ アメフラシで広範囲に継続ダメージ。じわじわ敵の行動範囲を狭められる</b>
</td></tr>
<tr><th style="background:#ffebee;color:#c62828">弱い点</th></tr>
<tr><td>
<b>✕ 連射が遅いから外すと一気にピンチ。対面の精度が求められる上級者向け武器</b><hr><b>✕ ポイズンミストはダメージ判定がなく、相手が避ければ効果が薄い</b>
</td></tr>
</table>
<p>Rブラスターエリートデコは、ブラスターの中でも最長の射程を持つ武器で、ラインマーカーとメガホンレーザーを使ったサポート性能も優れています。また、ラインマーカーはメインの直撃とのコンボで100ダメ以上を出すことができるので、直撃＆爆風で倒すよりも素早く倒すことができます。</p>

<h2>Rブラスターエリートデコのおすすめギア構成</h2>
<h3>迷ったらコレがおすすめ！</h3>
<table>
<tr>
...
<p>Rブラスターエリートデコは、アクション強化とイカダッシュ速度アップを中心に積みましょう。アクション強化はジャンプ撃ちのブレが少なくなるためジャンプ直撃が取りやすくなり、イカダッシュ速度アップは相手に遠くから一撃を与えて逃げられた際に追撃を与えやすくなります。</p>
...
<h2>Rブラスターエリートデコの立ち回りと使い方</h2>
<table>
<tr><td>Rブラスターエリートデコは持ち前の射程を活かして、後方から味方をサポートするのが基本です。視野を広く保ち、周囲の動きに合わせて後方で確実にサポート・アシストキルを狙いましょう。 近接戦が非常に弱い武器なので、基本的には敵が詰めてきにくい自陣の高台などから攻撃しましょう。</td></tr>
</table>
<h3>メインの直撃とラインマーカーのコンボを意識</h3>
<p>Rブラスターエリートデコのメインの直撃は85ダメージなので、ラインマーカーの35ダメージを先に当てておくか、追撃で与えることで敵を倒し切ることができます。メインの直撃&amp;爆風で倒すよりもキル速が早いので、積極的に狙っていきましょう。 ▶︎ラインマーカーの使い方と対策を見る</p>
<h3>メガホンは味方へのカバーを意識して使う</h3>
<p>Rブラスターエリートデコは味方よりも後ろに居るのが基本です。自分より前に居る味方と敵の位置を良く見て、味方が戦闘中もしくは戦闘を起こせそうな敵に対してメガホンを撃つことで、射程が届かない戦闘のカバーができて強力です。 ▶︎メガホンレーザー5.1chの使い方と避け方を見る</p>

<h2>Rブラスターエリートデコの対策</h2>
<table>
<tr><td>Rブラスターエリートデコは近距離が苦手な武器なので、対面する際には相手の射程で戦わずに、懐に潜り込んで近距離で戦いましょう。</td></tr>
</table>
<h3>塗りを良くしてからイカニンジャで詰める</h3>
<p>Rブラスターエリートデコは塗りが強くなく、クリアリングがしにくい武器です。近づきにくいと感じた時は、まずは全体的に塗りを広げ、クリアリングが困難な状況を作り出してから、イカニンジャで詰めましょう。</p>

<h2>Rブラスターエリートデコの性能</h2>
<h3>性能</h3>
<table>
