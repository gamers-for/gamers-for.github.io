...
<p class="a-paragraph"><img alt="ヒッセンASH" class="a-img img-placeholder" loading="lazy" src="/images/games/splatoon3/placeholders/black-440x248.png" width="440" height="248"/></p>
<p class="a-paragraph">スプラトゥーン3(スプラ3)における、ヒッセンASHを詳しくまとめていくよ。</p>
<p></p>
<div class="a-outline">
...
<h2 class="a-header--2" id="hl_1">ヒッセンASHの評価と役割</h2>
<table class="a-table a-table table--fixed a-table" style="">
<tr>
<td class="center" colspan="2" rowspan="4" width="50%">
<img alt="ヒッセンASH画像" class="a-img" height="80" loading="lazy" src="/images/games/splatoon3/weapons/tri-slosher-ash.png" width="80"/><br/>ヒッセンASH
</td>
...
<p class="a-paragraph">ヒッセンASHはメインウェポンのエイムが合わせやすくキル速度が速いですが、届く距離が短く近づくことができれば強いという武器なんだ。スペシャルのスミナガシートも使いこなせると頼もしいスペシャルといえます。</p>
<h2 class="a-header--2" id="hl_2">ヒッセンASHのおすすめギア構成</h2>
...
<p class="a-paragraph">ヒッセンASHのギア構成は基本ははこれが推奨だ。イカダッシュ速度アップを多めに積めば射程圏内まで相手に近づくことができる他、スペシャル減少量ダウンやスペシャル性能アップを積むおかげでスミナガシートの性能とチャージ速度をあげている。</p>
...
<p class="a-paragraph">ヒッセンASHは近づくことが難しいですが、イカニンジャを積めばかなり近づきやすくなるためイカニンジャも推奨のギアと言えます。スペシャル性能アップを1.1積むとスミナガシートの爆風が広がるため推奨。</p>
...
<td>前線で接敵する際や前線から引く際など、前線武器や短射程武器必須級の万能なギアなんだ。<hr class="a-table__line"/>
...
<td>基本は前線で立ち回る武器なので倒されやすいですが、このギアをつけるとスペシャルのチャージ速度を上げられる。<hr class="a-table__line"/>
...
<td>スミナガシートの爆風範囲が広くなり、キルしやすくなる。<hr class="a-table__line"/>
...
<td>※<span class="a-red">クツのメインギアパワー限定</span><hr class="a-table__line"/>スミナガシートの着地をかられにくくなるため、好みで積んでも良いだ。<hr class="a-table__line"/>なし</td>
</tr>
</table>

<h2 class="a-header--2" id="hl_3">ヒッセンASHの立ち回りと使い方</h2>
<table class="a-table a-table" style="">
<tr>
<td width="100%">
<div class="align">
...
<p class="a-paragraph"><img alt="横から潜伏キルを入れる" class="a-img img-placeholder" loading="lazy" src="/images/games/splatoon3/placeholders/black-440x248.png" width="440" height="248"/><br/>不意打ちでキルを拾うことを心がけましょう。。ヒッセンASHは短射程キル武器のからだなのでには前線付近の自インクに潜伏して、相手が気づかず近づいて来るところを狙うと良いだよ。</p>
<p class="a-paragraph">加えて味方を狙いに行っている相手の背後や横から近づいて、カバーキルを入れることも大切だよ。</p>
<h3 class="a-header--3" id="hm_7">スプラッシュボムでけん制や索敵をする</h3>
<p class="a-paragraph">サブのスプラッシュボムは投げた場所に一定時間、相手を弱体化させる霧を発生させます。敵陣高台など、相手に来てほしくない場所や退かしたい場所に投げてけん制しよう。もし返り討ちにあわず、距離を詰めて倒せそうであれば倒しに行ってもかまいない。</p>
<p class="a-paragraph">そのうえスプラッシュボムは音と霧のエフェクトで索敵をすることも可能だよ。相手の潜伏対策になるほか<a class="a-link" href="#">イカニンジャ</a>対策にもなるので、前線付近の相手インクが広がっている場所に投げておくと良いなんだ。</p>
<h3 class="a-header--3" id="hm_8">スミナガシートで前線を押し上げる</h3>
<p class="a-paragraph">スミナガシートは相手を退かせつつ、倒しきれるスペシャルだ。なので前線を押し上げたい時や、要所から相手を退かしたい時に使うと効果的なんだ。</p>
<p class="a-paragraph">スミナガシート終わりの着地を狩られないようにするために、壁裏などの着地地点が分かりにくい場所で使うと良いだ。さらに着地狩りのために詰めて来る相手にも注意しなきゃダメ。</p>

<h3 class="a-header--3" id="hm_9">スミナガシートは降下を使って相手の照準をずらす</h3>
<img alt="動画" class="a-img" height="50" loading="lazy" src="/images/games/splatoon3/placeholders/black-50x50.png" width="50"/>
<p class="a-paragraph">スミナガシート使用中にZLボタンで降下を取り入れるおかげで、相手の照準をずらすこともできる。上昇しながら敵に照準を合わせる必要があるので、すごく難しいですが、<b class="a-bold">上位ランクでは必須級のテクニック</b>です。<br/><a class="a-btn" href="#"><span>▶︎スミナガシートの使い方と当てるコツを見る</span></a></p>
<h2 class="a-header--2" id="hl_4">ヒッセンASHの対策</h2>
<table class="a-table a-table" style="">
<tr>
<td width="100%">
<div class="align">
...
<p class="a-paragraph">ヒッセンASHは射程の長い武器ではない。なので、もし自分の持っている武器がヒッセンASHより射程の長い武器なのであれば射程を押し付ける意識を持って無理に近づかないようにすれば楽に倒すことも可能だ。</p>
<h3 class="a-header--3" id="hm_11">スミナガシートの着地を狙う</h3>
<p class="a-paragraph">ヒッセンASHのスペシャルはスミナガシートなんだ。スミナガシートは使いこなすと強いスペシャルですが、着地の場所が常に見えるため着地を狙いやすい。このとき、受身術があるかどうかは確認しておくといいよ。</p>
<h3 class="a-header--3" id="hm_12">塗りを広げてイカニンジャを活かしにくくする</h3>
<p class="a-paragraph">ヒッセンASHはイカニンジャを活かして近づくことを狙ってきます。なので、塗りを広げておくだけでかなりヒッセンASHを動きにくくすることができるため推奨。</p>
<h2 class="a-header--2" id="hl_5">ヒッセンASHの性能と射程比較</h2>
...
<tr>
<th width="37%"><div class="align-left">
<div class="align"><b class="a-bold"><img alt="ヒッセンASH画像" class="a-img" height="30" loading="lazy" src="/images/games/splatoon3/weapons/tri-slosher-ash.png" width="30"/>ヒッセンASH</b></div>
</div></th>
<td width="63%"><div class="a-graph_wrap">
...
<h2 class="a-header--2" id="hl_6">ヒッセンASHの同名武器と違い</h2>
...
<tr>
<td class="center">
<img alt="ヒッセンASHASH画像" class="a-img" height="50" loading="lazy" src="/images/games/splatoon3/weapons/tri-slosher-ash.png" width="50"/>ヒッセンASHASH
...
<h2 class="a-header--2" id="hl_7">ヒッセンASHのアップデート調整内容</h2>
...
<tr>
<td class="center">アプデ前<img alt="動画" class="a-img" height="50" loading="lazy" src="/images/games/splatoon3/placeholders/black-50x50.png" width="50"/>50ダメージ半径約0.7</td>
</tr>
<tr>
<td class="center">アプデ後<img alt="動画" class="a-img" height="50" loading="lazy" src="/images/games/splatoon3/placeholders/black-50x50.png" width="50"/>50ダメージ半径約0.5</td>
</tr>
</table>
...
<tr>
<td class="center">アプデ後<img alt="動画" class="a-img" height="50" loading="lazy" src="/images/games/splatoon3/placeholders/black-50x50.png" width="50"/>50ダメージ半径約+0.2</td>
</tr>
</table>
