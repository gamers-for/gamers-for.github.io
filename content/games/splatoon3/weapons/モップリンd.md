---
title: "モップリンDのギア構成と立ち回り｜モプD【スプラトゥーン3】"
linkTitle: "モップリンD"
weight: 60
date: 2026-02-13
categories: ["スロッシャー"]
...
<p class="a-paragraph"><img alt="モップリンD" class="a-img img-placeholder" loading="lazy" src="/gamers-for/images/games/splatoon3/placeholder-icon.png" width="440"/></p>
...
<h2 class="a-header--2" id="hl_1">モップリンDの評価と役割</h2>
<table class="a-table a-table table--fixed a-table" style="">
<tr>
<td class="center" colspan="2" rowspan="4" width="50%">
<img alt="モップリンD画像" class="a-img" height="80" loading="lazy" src="/gamers-for/images/games/splatoon3/weapons/dread-wringer-d.png" width="80"/><br/>モップリンD
</td>
...
<h3 class="a-header--3" id="hm_2">盤面を維持しながら戦う中衛武器</h3>
...
<td width="100%">
<div class="align">
<img alt="強い点" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="16"/><b class="a-bold">射程が長めで塗り範囲が広い</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="強い点" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="16"/><b class="a-bold">曲射で壁裏や高低差などに強い</b>
</div>
</td>
</tr>
<tr>
...
<td width="100%">
<div class="align">
<img alt="弱い点" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/cross.png" width="16"/><b class="a-bold">射撃後の硬直が長め</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="弱い点" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/cross.png" width="16"/><b class="a-bold">メインウェポンのみでキルを取れる実力が必要</b>
</div>
</td>
</tr>
</table>
<p class="a-paragraph">モップリンDはメイン射撃の塗り性能や<a class="a-link" href="#">ジャンプビーコン</a>、<a class="a-link" href="#">ホップソナー</a>で盤面の維持・管理をしながら戦う中衛武器だよ。ただ注意として硬直の長めなメインでキルを取れなければ相手に押し込まれてしまう場面もあるので、使いこなすのが大変武器だ。</p>
<h2 class="a-header--2" id="hl_2">モップリンDのおすすめギア構成</h2>
...
<p class="a-paragraph">モップリンDは<a class="a-link" href="#">ビーコン</a>を持っているので、サブ性能で味方のサポートをやっておこう。カムバを積んでいれば切り返しをしやすくなるほか、復帰後ビーコンを置きやすくもなるよ。</p>
...
<td>移動力が上がり、サバイバル力も上がります。撃ち合い時や詰めて来た相手から引く際などに活きてきます。<hr class="a-table__line"/>
...
<td>相手をマーキングしたりダメージを与えて倒しやすくするホップソナーの発動ペースが上がります。<hr class="a-table__line"/>
...
<td>倒された際のスペシャル減少量が少なくなると、リスクを軽減して切り返ししやすくしてくれるよ。<hr class="a-table__line"/>
...
<td>相手インクの多い前線でも移動力を維持しやすくなり、サバイバル力を上げてくれる。<hr class="a-table__line"/>
...
<td>※<span class="a-red">アタマのメインギアパワー限定</span><hr class="a-table__line"/>やられた後しばらく足回りとインク燃費にブーストがかかり、スペシャルも速く溜まるようになる。逆転しやすくなるのでイチオシ。<hr class="a-table__line"/>なし</td>
</tr>
<tr>
...
<h2 class="a-header--2" id="hl_3">モップリンDの立ち回りと使い方</h2>
<table class="a-table a-table" style="">
<tr>
<td width="100%">
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="16"/><b class="a-bold">地形を利用して攻撃する</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="16"/><b class="a-bold">相手を倒す時は一点に当てる意識をする</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="16"/><b class="a-bold">塗る時は左右に視点を動かして範囲攻撃をする</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="16"/><b class="a-bold">メイン・サブ・スペを活かして盤面を維持・管理する</b>
</div>
</td>
</tr>
</table>
...
<h3 class="a-header--3" id="hm_8">メイン・サブ・スペを活かして盤面を維持・管理する</h3>
<p class="a-paragraph">モップリンDは塗れるメイン、味方の復帰を早められる<a class="a-link" href="#">サブ</a>、一定範囲で索敵やダメージを与えられる<a class="a-link" href="#">スペシャル</a>を持ちます。これらを活かして盤面の維持・管理を行うのが、モップリンDの主な役割になっている。</p>
<h2 class="a-header--2" id="hl_4">モップリンDの対策</h2>
<table class="a-table a-table" style="">
<tr>
<td width="100%">
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="16"/><b class="a-bold">地形の影を索敵・けん制をする</b>
</div>
<hr class="a-table__line"/>
<div class="align">
...
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="16"/><b class="a-bold">ジャンプビーコンを壊す</b>
</div>
</td>
</tr>
</table>
<h3 class="a-header--3" id="hm_9">地形の影を索敵・けん制をする</h3>
<p class="a-paragraph">モップリンDは<a class="a-link" href="#">スロッシャー</a>種の武器なので、曲射でのキルを狙って来ます。遮蔽物の裏や高台上・高台下など、こちら側から見て地形の影となる場所の索敵やけん制は欠かさないようにするのがベスト。</p>
<h3 class="a-header--3" id="hm_10">ダメージを受けたら引いて回復する</h3>
<p class="a-paragraph">モップリンDは1振り2発で90ダメージを出せる武器なんだ。ダメージを受けた際は一度引いて体力を回復すると、1振りで倒されてしまう危険性を回避できる。</p>
<h3 class="a-header--3" id="hm_11">ジャンプビーコンを壊す</h3>
<p class="a-paragraph">Xボタンで開くマップを見て、壊せそうな位置にある<a class="a-link" href="#">ジャンプビーコン</a>があれば壊しておくといいよ。索敵されたり、相手が早く復帰して来るのを防ぐことも可能だ。</p>

<h2 class="a-header--2" id="hl_5">モップリンDの性能と射程比較</h2>
...
<tr>
<th width="37%"><div class="align-left">
<div class="align"><b class="a-bold"><img alt="モップリンD画像" class="a-img" height="30" loading="lazy" src="/gamers-for/images/games/splatoon3/weapons/dread-wringer-d.png" width="30"/>モプD</b></div>
</div></th>
<td width="63%"><div class="a-graph_wrap">
<div class="a-graph"><div class="a-bar" style="width: 47%"></div></div>
<div class="a-label">3.1</div>
...
<h2 class="a-header--2" id="hl_6">モップリンDの同名武器と違い</h2>
...
<tr>
<td class="center">
<a class="a-link" href="/gamers-for/games/splatoon3/weapons/モップリン/"><img alt="モップリン画像" class="a-img" height="50" loading="lazy" src="/gamers-for/images/games/splatoon3/weapons/dread-wringer.png" width="50"/>モップリン</a>
</td>
<td class="center">
...
<tr>
<td class="center">
<b class="a-bold"><img alt="モップリンD画像" class="a-img" height="50" loading="lazy" src="/gamers-for/images/games/splatoon3/weapons/dread-wringer-d.png" width="50"/>モップリンD</b>
</td>
<td class="center">
...
<tr>
<td class="center">
<img alt="モップリン角画像" class="a-img" height="50" loading="lazy" src="/gamers-for/images/games/splatoon3/weapons/sloshing-machine-kaku.png" width="50"/>モップリン角
