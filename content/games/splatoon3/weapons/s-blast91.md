---
title: "S-BLAST91のおすすめギア構成と立ち回り｜エスブラ91【スプラトゥーン3】"
linkTitle: "S-BLAST91"
weight: 20
date: 2026-02-13
categories: ["ブラスター"]
...
<p class="a-paragraph"><img alt="S-BLAST91" class="a-img img-placeholder" loading="lazy" src="/images/games/splatoon3/weapons/s-blast-91-hero.png" width="440" height="248"/></p>
...
<h2 class="a-header--2" id="hl_1">S-BLAST91の評価と役割</h2>
<table class="a-table a-table table--fixed a-table" style="">
<tr>
<td class="center" colspan="2" rowspan="4" width="50%">
<img alt="S-BLAST91画像" class="a-img" height="80" loading="lazy" src="/images/games/splatoon3/weapons/s-blast-91.png" width="80"/><br/>S-BLAST91
</td>
...
<h3 class="a-header--3" id="hm_2">状況に応じて撃ち方を変えていく武器</h3>
...
<td width="100%">
<div class="align">
<img alt="強い点" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">射撃方法を変えることにより短距離中距離対応可能</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="強い点" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">クイックボムでアシストや逃げる敵を追撃できる</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="強い点" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">ナイスダマで逆転ができる</b>
</div>
</td>
</tr>
<tr>
...
<td width="100%">
<div class="align">
<img alt="弱い点" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/cross.png" width="16" height="18"/><b class="a-bold">扱いが少し難しい</b>
</div>
</td>
</tr>
</table>
<p class="a-paragraph">S-BLASTは立ち撃ちとジャンプ撃ち射撃距離が変わります。そういうわけで、ジャンプ撃ちと立ち撃ちを切り替えながら戦うおかげで前中距離どちらも対応可能な武器となる。</p>
<h2 class="a-header--2" id="hl_2">S-BLAST91のおすすめギア構成</h2>
...
<p class="a-paragraph">S-BLAST91は、一発当てた敵を逃さないようにするためイカダッシュ速度アップを多めに装備しよう。ジャンプ撃ちの射程が短め武器のため、イカダッシュ速度アップを好みでもっと積んでも良いだよ。</p>


<h2 class="a-header--2" id="hl_3">S-BLAST91の立ち回りと使い方</h2>
<table class="a-table a-table" style="">
<tr>
<td width="100%">
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">敵の位置によって射撃を使い分ける</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">クイックボムで味方のカバーや逃げる敵の追撃を意識する</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="NG行動" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/cross.png" width="16" height="18"/><b class="a-bold">ナイスダマで切り返しをする</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="NG行動" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/cross.png" width="16" height="18"/><b class="a-bold">高台は攻撃しにくいことを覚えておく</b>
</div>
</td>
</tr>
</table>
<h3 class="a-header--3" id="hm_4">敵の位置によって射撃を使い分ける</h3>
<p class="a-paragraph">S-BLAST91はジャンプ撃ちか立ち撃ちが射撃の性質が変化します。立ち撃ちは射程が長く、ジャンプ撃ちは射程が短めでなる。どちらにしても直撃は1確となるためダメージ的な変化はなく、敵が遠くにいるかどうかによって撃ち方を変えましょう。</p>
<h3 class="a-header--3" id="hm_5">クイボで味方のカバーや逃げる敵の追撃を意識する</h3>
<p class="a-paragraph">クイックボムは普段は足場塗りに使用するといいよ。足元塗りの苦手な武器のため、足元塗りが可能なクイボを使えるのは大きく意識して使っていこう。</p>
<h3 class="a-header--3" id="hm_6">ナイスダマで打開をする</h3>
<p class="a-paragraph">切り返しと抑えどちらにでも使っていくといいよ。。ナイスダマはとても強いスペシャルのからだ抑えの際に厳しい高台にいる長射程武器を下ろしたり、打開の際にオブジェクトに投げると前線を下げさせたり工夫次第でいろいろな使い方をできちゃう。</p>
<h3 class="a-header--3" id="hm_7">高台は攻撃しにくいことを覚えておく</h3>
<p class="a-paragraph">S-BLAST91はジャンプ撃ちの届く距離が短くなる特性上、高台上の敵に対して攻撃がしにくいんだ。高台上の敵を下ろしたい場合は、ナイスダマやクイボを使うと良いでしょう。</p>
<h2 class="a-header--2" id="hl_4">S-BLAST91の対策</h2>
<table class="a-table a-table" style="">
<tr>
<td width="100%">
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">足元の塗り状況が悪いときに戦う</b>
</div>
<hr class="a-table__line"/>
<div class="align">
...
<h3 class="a-header--3" id="hm_8">足元の塗り状況が悪いときに戦う</h3>
<p class="a-paragraph">S-BLAST91は足元の塗り状況が悪いときに戦うようにしよう。それにより、相手は足を取られるため一度足元にクイボを投げるなどする必要がありますがそのときは隙となるためキルをするチャンスが生まれるよ。</p>

<h3 class="a-header--3" id="hm_9">懐に潜り込む</h3>
<p class="a-paragraph">ブラスター類には足元に潜り込むのが有効だよ。S-BLASTの場合ジャンプ撃ちはリーチが短めでなりますが、それでも目の前に攻撃をすることは難しいためかなり有利に戦うことも可能だ。</p>
<h2 class="a-header--2" id="hl_5">S-BLAST91の性能と射程比較</h2>
...
<tr>
<th width="37%"><div class="align-left">
<div class="align"><b class="a-bold"><img alt="S-BLAST91画像" class="a-img" height="30" loading="lazy" src="/images/games/splatoon3/weapons/s-blast-91.png" width="30"/>エスブラ91</b></div>
</div></th>
<td width="63%"><div class="a-graph_wrap">
<div class="a-graph"><div class="a-bar" style="width: 46%"></div></div>
<div class="a-label">3.0</div>
...
<h2 class="a-header--2" id="hl_6">S-BLAST91の同名武器と違い</h2>
...
<tr>
<td class="center">
<a class="a-link" href="/games/splatoon3/weapons/s-blast92/"><img alt="S-BLAST92画像" class="a-img" loading="lazy" src="/images/games/splatoon3/weapons/s-blast-92.png" width="50" height="50"/>S-BLAST92</a>
</td>
<td class="center">
...
<tr>
<td class="center">
<b class="a-bold"><img alt="S-BLAST91画像" class="a-img" height="50" loading="lazy" src="/images/games/splatoon3/weapons/s-blast-91.png" width="50"/>S-BLAST91</b>
</td>
<td class="center">
...
<h2 class="a-header--2" id="hl_7">S-BLAST91のアプデ調整内容</h2>
<h3 class="a-header--3" id="hm_13">2025年3月13日のアップデート調整内容</h3>
<h4 class="a-header--4" id="hs_1">スペシャル必要ポイントの調整内容</h4>
<table class="a-table a-table" style="">
<tr>
<th>Ver.9.3.0</th>
</tr>
<tr>
<td>
<b class="a-bold">【弱体化内容】</b><br/><b class="a-bold">・スペシャル必要ポイントが増加しました。</b>　190→<span class="a-red">200</span>
</td>
</tr>
</table>
