---
title: "【スプラトゥーン3】スプラマニューバーのおすすめギアと立ち回り【スプラ3】"
linkTitle: "スプラマニューバー"
weight: 10
date: 2026-02-13
categories: ["マニューバー"]
...
<p class="a-paragraph"><img alt="スプラマニューバー" class="a-img img-placeholder" loading="lazy" src="/gamers-for/images/games/splatoon3/placeholder-icon.png" width="440"/></p>
<p class="a-paragraph">スプラトゥーン3(スプラ3)における、スプラマニューバー（マニュ）のすべてを詳しく紹介するよ。</p>
<p></p>
<div class="a-outline">
...
<h2 class="a-header--2" id="hl_1">スプラマニューバーの評価と役割</h2>
<table class="a-table a-table table--fixed a-table" style="">
<tr>
<td class="center" colspan="2" rowspan="4" width="50%">
<img alt="スプラマニューバー画像" class="a-img" height="80" loading="lazy" src="/gamers-for/images/games/splatoon3/weapons/splat-dualies.png" width="80"/><br/>スプラマニューバー
</td>
...
<td width="100%">
<div class="align">
<img alt="強い点" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="16"/><b class="a-bold">メインウェポンのスライド後キル速度が速い</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="強い点" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="16"/><b class="a-bold">スライドによって移動力が高い</b>
</div>
</td>
</tr>
<tr>
...
<hr class="a-table__line"/>
<div class="align">
<img alt="弱い点" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/cross.png" width="16"/><b class="a-bold">キューバンボムが若干噛み合っていない</b>
</div>
</td>
</tr>
</table>
<p class="a-paragraph">スプラマニューバーはスライドを使って前線でバリバリキルを狙っていく武器なんだ。カニタンクは超強いスペシャルといえ、逆転にも抑えにも使うことができますがサブのキューバンボムが前線で暴れるこの武器とは若干噛み合っていないのが残念なところだよ。</p>
<h2 class="a-header--2" id="hl_2">スプラマニューバーのおすすめギア構成</h2>
...
<p class="a-paragraph">前線で暴れたい人にはゾンビギア構成が推奨。前線でヘイトを買いながらキルを狙い、復活短縮ギアを使って素早く戻ってきましょう。</p>
...
<td>前線で立ち回る武器なので倒されやすいですが、このギアをつけるとスペシャルのチャージ速度を上げられる。<hr class="a-table__line"/>
...
<h2 class="a-header--2" id="hl_3">スプラマニューバーの立ち回りと使い方</h2>
<table class="a-table a-table" style="">
<tr>
<td width="100%">
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="20"/><b class="a-bold">立ち撃ちとスライド撃ちを使い分ける</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="20"/><b class="a-bold">キューバンボムで牽制する</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="20"/><b class="a-bold">カニタンクで前線を押し上げる</b>
</div>
</td>
</tr>
</table>
...
<table class="a-table a-table" style="">
<tr>
<td class="center" colspan="2" width="100%"><img alt="動画" class="a-img" height="50" loading="lazy" src="/gamers-for/images/games/splatoon3/placeholder-icon.png" width="50"/></td>
</tr>
<tr>
<th width="40%">操作</th>
...
<p class="a-paragraph">スプラマニューバーは、立ち撃ちで対面を始め、対面中にスライドを入れることを意識して戦うとよいよ。スライドは、詰めたり退いたりする際に使用しますが、スライド後に硬直を挟むので、<b class="a-bold">全ての敵に対しスライドを入れるのではなく、倒せる敵は立ち撃ちで対処し、隙を減らし</b>ましょう。</p>
<p class="a-paragraph">また、<a class="a-link" href="#">イカロール</a>や慣性キャンセルも使うと良いだよ。</p>

<h3 class="a-header--3" id="hm_6">キューバンボムで牽制する</h3>
<p class="a-paragraph">キューバンボムは牽制力の高いサブなんだ。高台など相手に立たれたくない場所や、長射程武器がいるポジションに投げて牽制しよう。ただ注意としてボムを投げすぎてインクが切れてしまい、隙を晒さないように気をつける必要があるよ。</p>
<h3 class="a-header--3" id="hm_7">カニタンクで前線を押し上げる</h3>
<p class="a-paragraph">カニタンクは、優勢な状況では裏側を取られにくく、その強さを押し付けてカウントを進めやすい。主に前線を押し上げたり、抑えたりする際に使用するのがおすすめ。</p>
<p class="a-paragraph">普段はは、前線の敵にZRの連射で対処し、遮蔽に隠れた相手にはRのタンク砲でダメージを与えていくように使うとよい。</p>
<h4 class="a-header--4" id="hs_1">不利な状況では落ちついて使用しよう</h4>
<p class="a-paragraph">塗りが圧倒的に苦しい展開では、カニタンクを活かすのは難しい。塗って少し前線を確保した後や、段差上などの有利な位置から使用することを心がけましょう。</p>
<p class="a-paragraph">加えて、敵に近寄られた際は、ZLで球体モードになり体当たりとカノン砲で対処することもできる。</p>
<p class="a-paragraph"><a class="a-btn" href="#"><span>▶︎カニタンクの使い方と倒し方を見る</span></a></p>
<h2 class="a-header--2" id="hl_4">スプラマニューバーの対策</h2>
<table class="a-table a-table" style="">
<tr>
<td width="100%">
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="16"/><b class="a-bold">スライドに慌てずに対処する</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="16"/><b class="a-bold">カニタンクに気を付ける</b>
</div>
</td>
</tr>
</table>
<h3 class="a-header--3" id="hm_8">スライドに慌てずに対処する</h3>
<p class="a-paragraph">スプラマニューバーは、スライドを使って近距離戦に持ち込んでくる武器ですが、スライドに慌ててエイムをずらしてしまうと相手の思う壺になってしまうため落ち着いてよく見るようにしよう。落ち着いて見てみるとスライドは実はそんなに早くはないため、意外とエイムで追うことができると感じるはずだ。</p>
<h3 class="a-header--3" id="hm_9">カニタンクに気をつける</h3>
<p class="a-paragraph">スペシャルのカニタンクには常に注意を払っておくのがベスト。キルを拾うことに長けているパワフルなスペシャルなので、相手のスペシャルの溜まり具合を確認しておきそろそろ溜まりそうと思った時は、距離を取ったりバレないようにするなどして迎撃する体制を整えましょう。</p>

<h2 class="a-header--2" id="hl_5">スプラマニューバーの性能と射程比較</h2>
...
<tr>
<th width="37%"><div class="align-left">
<div class="align"><b class="a-bold"><img alt="スプラマニューバー画像" class="a-img" height="30" loading="lazy" src="/gamers-for/images/games/splatoon3/weapons/splat-dualies.png" width="30"/>マニュ</b></div>
</div></th>
<td width="63%"><div class="a-graph_wrap">
...
<h2 class="a-header--2" id="hl_6">スプラマニューバーの同名武器と違い</h2>
...
<tr>
<td class="center">
<b class="a-bold"><img alt="スプラマニューバー画像" class="a-img" height="50" loading="lazy" src="/gamers-for/images/games/splatoon3/weapons/splat-dualies.png" width="50"/>スプラマニューバー</b>
</td>
<td class="center">
...
<tr>
<td class="center">
<a class="a-link" href="/gamers-for/games/splatoon3/weapons/スプラマニューバーコラボ/"><img alt="スプラマニューバーコラボ画像" class="a-img" height="50" loading="lazy" src="/gamers-for/images/games/splatoon3/weapons/enperry-splat-dualies.png" width="50"/>スプラマニューバーコラボ</a>
</td>
<td class="center">
...
<h2 class="a-header--2" id="hl_7">スプラマニューバーのアップデート調整内容</h2>
...
<td colspan="5">
<b class="a-bold">【強化内容】</b>
<br/><b class="a-bold">・スライドの移動速度をこれまでより速めるおかげで、移動距離は変えないまま、移動にかかる時間を約4/60秒間短縮しました。</b>
</td>
</tr>
</table>
