...
<p class="a-paragraph"><img alt="カーボンローラーANGL" class="a-img img-placeholder" loading="lazy" src="/images/games/splatoon3/placeholders/black-440x248.png" width="440" height="248"/></p>
<p class="a-paragraph">スプラトゥーン3(スプラ3)における、カーボンローラーANGL（カローラ）について徹底解説していくよ！</p>
<p></p>
<div class="a-outline">
...
<h2 class="a-header--2" id="hl_1">カーボンローラーANGLの評価と役割</h2>
<table class="a-table a-table table--fixed a-table" style="">
<tr>
<td class="center" colspan="2" rowspan="4" width="50%">
<img alt="カーボンローラーANGL画像" class="a-img" height="80" loading="lazy" src="/images/games/splatoon3/weapons/carbon-roller-angl.png" width="80"/><br/>カーボンローラーANGL
</td>
<th colspan="2" width="50%">総合評価</th>
</tr>
<tr>
<td class="center" colspan="2">
<img alt="C" class="a-img" loading="lazy" src="/images/games/splatoon3/tiers/c.webp" width="40" height="28"/>
</td>
</tr>
<tr>
...
<td width="100%">
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="20" height="22"/><b class="a-bold">近接戦に強いキル武器</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="20" height="22"/><b class="a-bold">デコイチラシで裏取りキルを決められる</b>
</div>
</td>
</tr>
<tr>
...
<td width="100%">
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="20" height="22"/><b class="a-bold">1確のリーチが短め</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="20" height="22"/><b class="a-bold">タンサンボムがいまいち</b>
</div>
</td>
</tr>
</table>
<p class="a-paragraph">カーボンローラーANGLは、相手に超至近距離まで近づいて相手の意表をついてキルを狙う武器だ。デコイチラシを使って相手の裏取りを狙うことができますが、タンサンボムはいまいち噛み合っておらずあまり現状の評価は高くない武器なんだ。</p>
<h2 class="a-header--2" id="hl_2">カーボンローラーANGLのおすすめギア構成</h2>
...
<p class="a-paragraph">カーボンローラーANGLは、相手に近づくことが何よりも大事な武器のためイカニンジャとイカダッシュ速度アップを大量に積むのは必須なんだ。残りは相手インクの上でも動きやすいように相手インク影響軽減を積むのが推奨。</p>
...
<td>前線で接敵する際や前線から引く際など、素早い移動が欠かせない前線武器には必須級のギアだ。<hr class="a-table__line"/>
...
<td>足回りがあるカーボンローラーANGLとデコイチラシはすごくマッチするので、奇襲を多く仕掛けたい場合にスペシャル増加量UPを積むのが良い選択だ。<hr class="a-table__line"/>
...
<td>倒された際のやられてもゲージの減りが少ないから、劣勢でもスペシャルで巻き返すチャンスを維持できるなる。<hr class="a-table__line"/>
...
<td>※<span class="a-red">アタマのメインギアパワー限定</span><hr class="a-table__line"/>復帰直後に移動・インク・スペシャル回転が一時的に上がるので、素早いリカバリーが可能。復活時間短縮との相性も良く、切り返ししやすくなる。<hr class="a-table__line"/>なし</td>
</tr>
<tr>
...
<td>※<span class="a-red">フクのメインギアパワー限定</span><hr class="a-table__line"/>相手に接近する際、気づかれにくくしてくれるよ。確実に仕留めやすくなるのも強みだよ。。理由はそのうえ対面時に相手が自分の位置を見失いやすくなるから<hr class="a-table__line"/>なし</td>
</tr>
<tr>
...
<td>※<span class="a-red">クツのメインギアパワー限定</span><hr class="a-table__line"/>受け身後すぐにキルを取りやすいカーボンローラーANGLは、実現性が高く好相性だ。<hr class="a-table__line"/>なし</td>
</tr>
</table>

<h2 class="a-header--2" id="hl_3">カーボンローラーANGLの立ち回りと使い方</h2>
<table class="a-table a-table" style="">
<tr>
<td width="100%">
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="20" height="22"/><b class="a-bold">潜伏や裏取りでキルを狙う</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="20" height="22"/><b class="a-bold">タンサンボムでけん制するのを忘れない</b>
</div>
</td>
</tr>
</table>
<h3 class="a-header--3" id="hm_5">潜伏や裏取りでキルを狙う</h3>
<p class="a-paragraph">カーボンローラ潜伏や裏取りがめちゃくちゃ有効だよ。。理由はーは射程が短めですが、素早い一振りで相手を倒せて足回りもあるから潜伏やデコイチラシを使用した裏取りで確実に近づいてキルを取り、人数有利状況を作るようにしよう。</p>
<h3 class="a-header--3" id="hm_6">タンサンボムでけん制するのを忘れない</h3>
<p class="a-paragraph">タンサンボムはけん制の手段として有効なサブなんだ。それに、タンサンボムを相手の少し後ろに投げてから距離を詰めることにより、相手は自身とタンサンボムの二方向に意識を割く必要があるため、キルが取りやすくなるよ。</p>
<p class="a-paragraph">キルが取れなくても、相手を大幅に下げさせることができただけで、有利状況を作れるきっかけになる。</p>
<h2 class="a-header--2" id="hl_4">カーボンローラーANGLの対策</h2>
<table class="a-table a-table" style="">
<tr>
<td width="100%">
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">相手インクの繋がりを切っておく</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">デコイチラシを常に警戒する</b>
</div>
</td>
</tr>
</table>
<h3 class="a-header--3" id="hm_7">相手インクの繋がりを切っておく</h3>
<p class="a-paragraph">カーボンローラーANGLは、気づかれないようにインクの中を進んでくるためインクの繋がりを切っておくのはすごく大事だ。インクの繋がりが切られていると、必ず一旦顔をだして塗りをしなければならないためその度に相手に存在を晒す必要があるためかなりカーボンの脅威が薄れるため有効なんだ。</p>
<h3 class="a-header--3" id="hm_8">デコイチラシを常に警戒する</h3>
<p class="a-paragraph">カーボンローラーANGLは、デコイチラシで裏どりを狙ってくるため常に視野は広く持っておくのがベスト。デコイチラシ自体はそこまでパワフルなスペシャルではないので接近に気づいてしまえばそんなに対処に困ることはないよ。</p>

<h2 class="a-header--2" id="hl_5">カーボンローラーANGLの性能と射程比較</h2>
...
<div class="align"><b class="a-bold"><img alt="カーボンローラーANGL画像" class="a-img" height="30" loading="lazy" src="/images/games/splatoon3/weapons/carbon-roller-angl.png" width="30"/>カーボン</b></div>
</div></th>
...
<h2 class="a-header--2" id="hl_6">カーボンローラーANGLの同名武器と違い</h2>
...
<tr>
<td class="center">
<b class="a-bold"><img alt="カーボンローラーANGL画像" class="a-img" height="50" loading="lazy" src="/images/games/splatoon3/weapons/carbon-roller-angl.png" width="50"/>カーボンローラーANGL</b>
</td>
<td class="center">
...
<tr>
<td class="center">
<a class="a-link" href="/games/splatoon3/weapons/カーボンローラーANGLデコ/"><img alt="カーボンローラーANGLデコ画像" class="a-img" loading="lazy" src="/images/games/splatoon3/weapons/carbon-roller-deco.png" width="50" height="50"/>カーボンローラーANGLデコ</a>
</td>
<td class="center">
...
<tr>
<td class="center">
<img alt="カーボンローラーANGLANGL画像" class="a-img" height="50" loading="lazy" src="/images/games/splatoon3/weapons/carbon-roller-angl.png" width="50"/>カーボンローラーANGLANGL
...
<h2 class="a-header--2" id="hl_7">カーボンローラーANGLのアップデート調整内容</h2>
