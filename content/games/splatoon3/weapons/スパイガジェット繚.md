...
<p class="a-paragraph"><img alt="スパイガジェット繚" class="a-img img-placeholder" loading="lazy" src="/images/games/splatoon3/placeholder-icon.png" width="440"/></p>
...
<p class="a-paragraph"><img alt="人数有利で対面する" class="a-img img-placeholder" loading="lazy" src="/images/games/splatoon3/placeholder-icon.png" width="440"/><br/>スパイガジェット繚は<a class="a-link" href="#">シェルター</a>相手の攻撃を防げます。。種の武器のからだただ一方向の攻撃しか防げず、カサの耐久力が低いので、複数人を同時に相手にすることはできない。そういうわけで対面を仕掛ける時は1対1、もしくは味方と連携して人数同数か人数有利な対面になるようにするのがベスト。人数有利な対面を始めるには、味方のカバーに入る意識をして立ち回ると良いだ。</p>

<h3 class="a-header--3" id="hm_8">キル・アシストキルを心がける</h3>
<p class="a-paragraph"><img alt="キル・アシストキルでカサ復活" class="a-img img-placeholder" loading="lazy" src="/images/games/splatoon3/placeholder-icon.png" width="440"/><br/>スパイガジェット繚はカサの耐久力が低いので、対面してもすぐにカサを壊されてしまいがちなんだ。ただキルやアシストキルが入ると、カサが即復活して耐久力が回復します。カーリングボムや味方へのカバーなどでキルやキルアシストが多く入るプレイを心がけるおかげで、対面を行える回数が増えて、より自チームに貢献できるようになるでしょう。</p>
<h3 class="a-header--3" id="hm_9">相手を追い込むようにメガホンレーザー5.1chを使う</h3>
<p class="a-paragraph"><img alt="追い込むようにサメライド" class="a-img img-placeholder" loading="lazy" src="/images/games/splatoon3/placeholder-icon.png" width="440"/><br/>メガホンレーザー5.1chは相手を追い込むようにして使うと良いだ。味方が対面している場所へ急行して爆発でキルしたり、壁際に相手を追い込んで爆発でキルしたり、前線の自インクと爆発の塗りで相手を挟んだりするとキルが取りやすくなる。</p>
...
<img alt="アプデ前メガホンレーザー5.1ch塗り" class="a-img img-placeholder" loading="lazy" src="/images/games/splatoon3/placeholder-icon.png" width="440"/><span class="imageLink__icon">拡大</span>
...
<img alt="アプデ後メガホンレーザー5.1ch塗り" class="a-img img-placeholder" loading="lazy" src="/images/games/splatoon3/placeholder-icon.png" width="440"/><span class="imageLink__icon">拡大</span>
