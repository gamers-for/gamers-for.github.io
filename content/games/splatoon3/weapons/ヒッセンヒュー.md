...
<p class="a-paragraph"><img alt="ヒッセンヒュー" class="a-img img-placeholder" loading="lazy" src="/gamers-for/images/games/splatoon3/placeholder-icon.png" width="440"/></p>
...
<img alt="ヒッセンヒュー画像" class="a-img" height="80" loading="lazy" src="/gamers-for/images/games/splatoon3/weapons/tri-slosher-nouveau.png" width="80"/><br/>ヒッセンヒュー
</td>
...
<td width="100%">
<div class="align">
<img alt="強い点" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="16"/><b class="a-bold">メイン射撃の攻撃を相手に当てやすくキル速度が速い</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="強い点" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="16"/><b class="a-bold">タンサンボムで塗り・けん制ができてコンボ攻撃ができる</b>
</div>
</td>
</tr>
<tr>
...
<td width="100%">
<div class="align">
<img alt="弱い点" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/cross.png" width="16"/><b class="a-bold">メインウェポンのリーチが短め</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="弱い点" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/cross.png" width="16"/><b class="a-bold">スクリュースロッシャーとの差別化が必要</b>
</div>
</td>
</tr>
</table>
...
<p class="a-paragraph">ヒッセンヒューはメイン62ダメージとタンサンボム直撃50ダメージのコンボ攻撃も可能だ。一方でタンサンボムが爆風35ダメージだった場合、メイン1発との合計は97ダメージとなり確実に相手を倒すことができない。同じ<a class="a-link" href="#">スロッシャー</a>種の<a class="a-link" href="/gamers-for/games/splatoon3/weapons/スクリュースロッシャー/">スクリュースロッシャー</a>との差別化が課題となる。</p>
...
<td width="100%">
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="20"/><b class="a-bold">潜伏してキルを狙う</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="20"/><b class="a-bold">タンサンボムで塗りとけん制をする</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="20"/><b class="a-bold">タンサンボムで道を作って相手へ近づく</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="20"/><b class="a-bold">エナジースタンドで強気に攻める</b>
</div>
</td>
</tr>
</table>
<h3 class="a-header--3" id="hm_6">潜伏してキルを狙う</h3>
<p class="a-paragraph"><img alt="横から潜伏キルを入れる" class="a-img img-placeholder" loading="lazy" src="/gamers-for/images/games/splatoon3/placeholder-icon.png" width="440"/><br/>ヒッセンヒューは短射程キル武器のため、不意打ちで敵を倒すことを心がけましょう。そういうわけでには前線付近の自インクに潜伏して、相手が気づかず近づいて来るところを狙うと良いだ。</p>
...
<td width="100%">
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="16"/><b class="a-bold">射程を押し付ける</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="16"/><b class="a-bold">タンサンボムの隙を狙う</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="16"/><b class="a-bold">サブ影響軽減のギアパワーを積む</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/gamers-for/images/games/splatoon3/markers/check.png" width="16"/><b class="a-bold">塗りを広げて不意打ちされにくくする</b>
</div>
</td>
</tr>
</table>
...
<p class="a-paragraph">タンサンボムの爆風35ダメージとメイン1発62ダメージが当たると合計97ダメージとなり、少しでもダメージを負っていると倒されてしまいるよ。その対策として<a class="a-link" href="/gamers-for/games/splatoon3/gear/">ギア</a>パワーの<a class="a-link" href="#">サブ影響軽減</a>を付けるおかげで、このコンボ攻撃を耐えやすくなるよ。</p>
<h3 class="a-header--3" id="hm_13">塗りを広げて不意打ちされにくくする</h3>
<p class="a-paragraph">ヒッセンヒューは<a class="a-link" href="/gamers-for/games/splatoon3/gear/">ギア</a>パワーの<a class="a-link" href="#">イカニンジャ</a>を活かして接近してきたり、エナジースタンドで高められた移動力を活かして接近してキルを狙ってきます。だから塗りを広げておくだけでも、ヒッセンヒューを動きにくくすることができるため推奨。</p>
...
<tr>
<th width="37%"><div class="align-left">
<div class="align"><b class="a-bold"><img alt="ヒッセンヒュー画像" class="a-img" height="30" loading="lazy" src="/gamers-for/images/games/splatoon3/weapons/tri-slosher-nouveau.png" width="30"/>ヒッヒュー</b></div>
</div></th>
<td width="63%"><div class="a-graph_wrap">
<div class="a-graph"><div class="a-bar" style="width: 33%"></div></div>
<div class="a-label">2.2</div>
...
<tr>
<td class="center">
<a class="a-link" href="/gamers-for/games/splatoon3/weapons/ヒッセン/"><img alt="ヒッセン画像" class="a-img" height="50" loading="lazy" src="/gamers-for/images/games/splatoon3/weapons/tri-slosher.png" width="50"/>ヒッセン</a>
</td>
<td class="center">
...
<tr>
<td class="center">
<b class="a-bold"><img alt="ヒッセンヒュー画像" class="a-img" height="50" loading="lazy" src="/gamers-for/images/games/splatoon3/weapons/tri-slosher-nouveau.png" width="50"/>ヒッセンヒュー</b>
</td>
<td class="center">
...
<tr>
<td class="center">
<img alt="ヒッセンASH画像" class="a-img" height="50" loading="lazy" src="/gamers-for/images/games/splatoon3/weapons/tri-slosher-ash.png" width="50"/>ヒッセンASH
