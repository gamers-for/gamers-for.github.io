---
title: "ボールドマーカーネオのギア構成と立ち回り｜ボルネオ【スプラトゥーン3】"
...
<p class="a-paragraph"><img alt="ボールドマーカーネオ" class="a-img img-placeholder" loading="lazy" src="/images/games/splatoon3/weapons/neo-sploosh-o-matic-hero.png" width="440" height="248"/></p>
<p class="a-paragraph">スプラトゥーン3(スプラ3)における、ボールドマーカーネオ（ボルネオ）を詳しくまとめていくよ。</p>
<p></p>
<div class="a-outline">
...
<h2 class="a-header--2" id="hl_1">ボールドマーカーネオの評価と役割</h2>
<table class="a-table a-table table--fixed a-table" style="">
<tr>
<td class="center" colspan="2" rowspan="4" width="50%">
<img alt="ボールドマーカーネオ画像" class="a-img" height="80" loading="lazy" src="/images/games/splatoon3/weapons/neo-sploosh-o-matic.png" width="80"/><br/>ボールドマーカーネオ
</td>
...
<h3 class="a-header--3" id="hm_2">機動力の高さとビーコンを活かして立ち回る</h3>
...
<td width="100%">
<div class="align">
<img alt="強い点" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">移動力がかなり高く塗り性能も高い</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="強い点" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">ビーコンにより前線復帰を早められる</b>
</div>
</td>
</tr>
<tr>
...
<td width="100%">
<div class="align">
<img alt="弱い点" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/cross.png" width="16" height="18"/><b class="a-bold">メイン射撃のリーチが短め</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="弱い点" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/cross.png" width="16" height="18"/><b class="a-bold">届く距離が短くサブでけん制もできない</b>
</div>
</td>
</tr>
</table>
<p class="a-paragraph">ボールドマーカーネオはフットワークの高さと<a class="a-link" href="#">ジャンプビーコン</a>で相手を翻弄する武器なんだ。味方全体の復帰を早められるのは強いですが、リーチが短めでサブでけん制もできないので射程を活かして戦われると厳しい武器になっている。</p>
<h2 class="a-header--2" id="hl_2">ボールドマーカーネオのおすすめギア構成</h2>
<h3 class="a-header--3" id="hm_3">最前線で敵陣を荒らす構成</h3>
<table class="a-table a-table" style="">
<tr>
<th width="34%">メイン</th>
<th width="22%">サブ①</th>
...
<p class="a-paragraph">ボールドマーカーネオは足回りは高いものの射程がとても短くサブでけん制もできないので、最前線を素早く移動したり<a class="a-link" href="#">ジャンプビーコン</a>を置いたりして敵陣を荒らす戦い方が要求されるよ。そういうわけで倒された時のスペシャルゲージ減少量を抑える「スペシャル減少量ダウン」、復活後20秒間スペシャル系・移動系・インク系のギアパワーの効果を得られる「カムバック」を積んでいる。</p>
<p class="a-paragraph">加えてサブがジャンプビーコンなので、サブ性能アップでビーコンへのジャンプ速度を上げて、味方の復帰時間をさらに短縮しているよ。ジャンプビーコンがあるとはいえ、仲間にジャンプする場面はあるのでステルスジャンプは付けておこう。</p>
...
<td>フットワークが上がり、相手に接近しやすくなったり生存性が上がります。<hr class="a-table__line"/>
...
<td>倒された際のリスクを軽減してスペシャルの回転を落とさないようにできる。<hr class="a-table__line"/>
...
<td>味方全員がジャンプビーコンへ飛ぶ時間を短縮するおかげで、チーム全体の前線復帰を早くします。<hr class="a-table__line"/>
...
<td>※<span class="a-red">アタマのメインギアパワー限定</span><hr class="a-table__line"/>倒された後しばらくの間、インク効率と移動力が上がりスペシャルが溜まりやすくなるので切り返しをしやすくなる。<hr class="a-table__line"/>なし</td>
</tr>
<tr>
...
<td>※<span class="a-red">フクのメインギアパワー限定</span><hr class="a-table__line"/>接敵する際、相手に見つかりにくくなって倒しやすくなる。<hr class="a-table__line"/>なし</td>
</tr>
<tr>
...
<h2 class="a-header--2" id="hl_3">ボールドマーカーネオの立ち回りと使い方</h2>
<table class="a-table a-table" style="">
<tr>
<td width="100%">
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">前線で動き回って相手を撹乱させる</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">ビーコンを常に置いておく</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">メガホンレーザーは主に味方のカバーに使う</b>
</div>
</td>
</tr>
</table>
<h3 class="a-header--3" id="hm_5">前線で動き回って相手を撹乱する</h3>
<p class="a-paragraph">ボールドマーカーネオは足回りがとても高く、接近できればキル速の速い武器だよ。前線で動き回りつつも生存すると、相手の注意を引きつけ錯乱させて、味方を動きやすくするといいよ。</p>
<p class="a-paragraph">相手の背後や横から近づいて、キルを入れられそうであれば相手をキルするのがおすすめ。</p>

<h3 class="a-header--3" id="hm_6">ビーコンを常に置いておく</h3>
<p class="a-paragraph">ボールドマーカーネオはジャンプビーコンで味方の復帰を早めたり、相手の注目の分散や索敵をするようにするのがベスト。ステージ上からビーコンを切らさないようにするおかげで前線を下げないように、切り返し状況にならないようにできる。</p>
<p class="a-paragraph"><a class="a-btn" href="#"><span>▶︎ジャンプビーコンの性能と使える武器一覧を見る</span></a></p>
<h3 class="a-header--3" id="hm_7">メガホンレーザーは主に味方のカバーに使う</h3>
<p class="a-paragraph">スペシャルのメガホンレーザーは主に味方のカバーに使いましょう。自分の対面のために使っても良いですが、射程がとても短いのでメインと合わせて使うのは難しいよ。</p>
<p class="a-paragraph"><a class="a-btn" href="#"><span>▶︎メガホンレーザー5.1chの使い方を見る</span></a></p>
<h2 class="a-header--2" id="hl_4">ボールドマーカーネオの対策</h2>
<table class="a-table a-table" style="">
<tr>
<td width="100%">
<div class="align">
...
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">クリアリングや索敵をしっかりする</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">ビーコンはマップを見て壊しておく</b>
</div>
</td>
</tr>
</table>
<h3 class="a-header--3" id="hm_8">射程差を活かして戦う</h3>
<p class="a-paragraph">ボールドマーカーネオは射程がかなり短い武器なんだ。だから射程差を活かして、ボールドマーカーネオの間合いに入らなければ倒されることはないよ。</p>
<p class="a-paragraph">相手インクを塗り替えしておきつつ、接敵した際は後ろに下がりながら撃つ「引き撃ち」で距離を保って迎え撃ちましょう。</p>
<h3 class="a-header--3" id="hm_9">クリアリングや索敵をしっかりする</h3>
<p class="a-paragraph">ボールドマーカーネオは相手インクに潜伏して、不意打ちのキルを狙ってくることがある。そういうわけで<span class="a-red">相手インクを塗り替えたりサブを使って相手がいないことを確かめる「クリアリング」</span>をしっかり行いましょう。</p>
<p class="a-paragraph">また<a class="a-link" href="#">ポイントセンサー</a>や<a class="a-link" href="#">トラップ</a>、<a class="a-link" href="#">ラインマーカー</a>などでマーキングを付けるおかげでボールドマーカーネオの位置を把握しておき、行動を制限させることもできる。</p>

<h3 class="a-header--3" id="hm_10">ビーコンはマップを見て壊しておく</h3>
<p class="a-paragraph"><a class="a-link" href="#">ジャンプビーコン</a>はXボタンで開くマップで確認して、壊せそうな位置にあれば壊しておこう。相手の復帰を早めるのを阻止したり、不意に横から奇襲されることを防げます。</p>
<p class="a-paragraph">それにビーコン付近は潜伏していても位置がバレてしまうので、壊して相手有利の状況を作らせないようにしよう。</p>
<h2 class="a-header--2" id="hl_5">ボールドマーカーネオの性能と射程比較</h2>
...
<tr>
<th width="37%"><div class="align-left">
<div class="align"><b class="a-bold"><img alt="ボールドマーカーネオ画像" class="a-img" height="30" loading="lazy" src="/images/games/splatoon3/weapons/neo-sploosh-o-matic.png" width="30"/>ボルネオ</b></div>
</div></th>
<td width="63%"><div class="a-graph_wrap">
<div class="a-graph"><div class="a-bar" style="width: 18%"></div></div>
<div class="a-label">1.2</div>
...
<h2 class="a-header--2" id="hl_6">ボールドマーカーネオの同名武器と違い</h2>
...
<tr>
<td class="center">
<a class="a-link" href="/games/splatoon3/weapons/ボールドマーカー/"><img alt="ボールドマーカー画像" class="a-img" height="50" loading="lazy" src="/images/games/splatoon3/weapons/sploosh-o-matic.png" width="50"/>ボールドマーカー</a>
</td>
<td class="center">
...
<tr>
<td class="center">
<b class="a-bold"><img alt="ボールドマーカーネオ画像" class="a-img" height="50" loading="lazy" src="/images/games/splatoon3/weapons/neo-sploosh-o-matic.png" width="50"/>ボールドマーカーネオ</b>
</td>
<td class="center">
...
<h2 class="a-header--2" id="hl_7">ボールドマーカーネオのアップデート調整内容</h2>
...
<tr>
<td>・スペシャル必要ポイントが減少しました。<b class="a-bold">180→170</b>
</td>
</tr>
</table>
