---
title: "S-BLAST92のおすすめギア構成と立ち回り｜エスブラ92【スプラトゥーン3】"
linkTitle: "S-BLAST92"
weight: 60
date: 2026-02-13
categories: ["ブラスター"]
...
<p class="a-paragraph"><img alt="S-BLAST92" class="a-img img-placeholder" loading="lazy" src="/images/games/splatoon3/weapons/s-blast-92-hero.png" width="440" height="248"/></p>
...
<h2 class="a-header--2" id="hl_1">S-BLAST92の評価と役割</h2>
<table class="a-table a-table table--fixed a-table" style="">
<tr>
<td class="center" colspan="2" rowspan="4" width="50%">
<img alt="S-BLAST92画像" class="a-img" loading="lazy" src="/images/games/splatoon3/weapons/s-blast-92.png" width="80" height="80"/><br/>S-BLAST92
</td>
...
<h3 class="a-header--3" id="hm_2">前中衛で戦うことができる武器</h3>
...
<td width="100%">
<div class="align">
<img alt="強い点" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">射程が長く直撃なら1確</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="強い点" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">近距離遠距離両対応ができる</b>
</div>
</td>
</tr>
<tr>
...
<td width="100%">
<div class="align">
<img alt="弱い点" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/cross.png" width="16" height="18"/><b class="a-bold">高台に攻撃を通すのが難しい</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="弱い点" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/cross.png" width="16" height="18"/><b class="a-bold">サブスペがどちらもあまり強くない</b>
</div>
</td>
</tr>
</table>
<p class="a-paragraph">S-BLAST92は、射程を戦いながら変更することができるブラスターだ。立ち撃ちなら長い射程となりジャンプ撃ちなら短い射程となりますが、直撃の場合はすべて1確の威力が出ます。かなり玄人向きで極めがいのある武器と言えます。</p>
<h2 class="a-header--2" id="hl_2">S-BLAST92のおすすめギア構成</h2>
...
<p class="a-paragraph">S-BLAST92は、一発当てた敵を逃さないようにするためイカダッシュ速度アップを多めに装備しよう。イカダッシュ速度アップを好みでもっと積んでも良いだよ。。理由はジャンプ撃ちのリーチが短め武器のから</p>


<h2 class="a-header--2" id="hl_3">S-BLAST92の立ち回りと使い方</h2>
<table class="a-table a-table" style="">
<tr>
<td width="100%">
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">敵の位置によって射程を使い分ける</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">トラップを後ろに仕掛けておく</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">サメライドは密集地帯や相手のスペシャルに合わせて使う</b>
</div>
</td>
</tr>
</table>
<h3 class="a-header--3" id="hm_4">敵の位置によって射程を使い分ける</h3>
<p class="a-paragraph">S-BLAST92は、敵の位置によって射程を使い分けましょう。立ち撃ちは射程が長く、ジャンプ撃ちは射程が短めでなるよ。どちらにしても直撃は1確となるためダメージ的な変化はなく、味方が遠くにいるかどうかによって撃ち方を変えましょう。</p>
<h3 class="a-header--3" id="hm_5">トラップを後ろに仕掛けておく</h3>
<p class="a-paragraph">トラップは自分の後ろのルートを守るために使いましょう。S-BLAST92は突然近くに来られると直撃を取ることが求められるためかなり厳しい戦いを強いられてしまいる。なのでトラップをうまく使うと相手に簡単に後ろを取られないようにするのがベスト。</p>
<h3 class="a-header--3" id="hm_6">サメライドは密集地帯や相手のスペシャルに合わせて使う</h3>
<p class="a-paragraph">サメライドは味方と相手が混戦しているタイミングで使うのがイチオシ。混戦時はダメージを多少なり受けている場合が多く、サメライドの擦りダメージでも倒すこともできる。加えて、相手のスペシャルに合わせて使うのも有効でグレートバリアの真ん中を通ると一撃で壊すことも可能だ。</p>
<h2 class="a-header--2" id="hl_4">S-BLAST92の対策</h2>
<table class="a-table a-table" style="">
<tr>
<td width="100%">
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">相手の懐に潜り込んで戦う</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">トラップに気を付ける</b>
</div>
<hr class="a-table__line"/>
<div class="align">
<img alt="ポイント" class="a-img" loading="lazy" src="/images/games/splatoon3/markers/check.png" width="16" height="18"/><b class="a-bold">サメライドの溜まり具合に気をつける</b>
</div>
</td>
</tr>
</table>
<h3 class="a-header--3" id="hm_7">相手の懐に潜り込んで戦う</h3>
<p class="a-paragraph">S-BLAST92の対策は、相手の懐に潜り込んで戦いましょう。懐に潜り込んで戦うと直撃以外では爆風を二発当てる必要があるため余裕ができる。</p>
<h3 class="a-header--3" id="hm_8">トラップに気を付ける</h3>
<p class="a-paragraph">後ろを狙う際は相手のトラップに気をつけましょう。トラップは当たってしまうとセンサーがついて自分の位置が相手にバレてしまうため、裏どりを諦めて下がらなくてはいけなくなるよ。</p>

<h3 class="a-header--3" id="hm_9">サメライドの溜まり具合に気を付ける</h3>
<p class="a-paragraph">相手のサメライドにも気をつけましょう。対面中に突然吐かれると倒し切る前にサメライドが発動してしまい、多くの場合キルされてしまいるよ。そういうわけで、相手のサメライドのゲージ量は常に頭に入れておこう。</p>
<h2 class="a-header--2" id="hl_5">S-BLAST92の性能と射程比較</h2>
...
<hr class="a-table__line"/>爆風：70.0〜50.0
...
<tr>
<th>射程<br/>(試し撃ちライン)</th>
<td class="center">立ち撃ち最大：約3.3<br/>立ち撃ち直撃：約3.0<br/>ジャンプ撃ち最大：約2.4<br/>ジャンプ撃ち直撃：1.6</td>
</tr>
<tr>
...
<tr>
<th width="37%"><div class="align-left">
<div class="align"><b class="a-bold"><img alt="S-BLAST92画像" class="a-img" loading="lazy" src="/images/games/splatoon3/weapons/s-blast-92.png" width="30" height="30"/>エスブラ92</b></div>
</div></th>
<td width="63%"><div class="a-graph_wrap">
<div class="a-graph"><div class="a-bar" style="width: 46%"></div></div>
<div class="a-label">3.0</div>
...
<h2 class="a-header--2" id="hl_6">S-BLAST92の同名武器と違い</h2>
...
<tr>
<td class="center">
<b class="a-bold"><img alt="S-BLAST92画像" class="a-img" loading="lazy" src="/images/games/splatoon3/weapons/s-blast-92.png" width="50" height="50"/>S-BLAST92</b>
</td>
<td class="center">
...
<tr>
<td class="center">
<a class="a-link" href="/games/splatoon3/weapons/s-blast91/"><img alt="S-BLAST91画像" class="a-img" height="50" loading="lazy" src="/images/games/splatoon3/weapons/s-blast-91.png" width="50"/>S-BLAST91</a>
</td>
<td class="center">
...
<h2 class="a-header--2" id="hl_7">S-BLAST92のアプデ調整内容</h2>
...
<tr>
<td>
<b class="a-bold">【強化内容】</b><br/>・<b class="a-bold">飛距離が長い状態の爆発で50.0ダメージを与える範囲の半径を、約11%拡大しました。</b>
</td>
</tr>
...
<h3 class="a-header--3" id="hm_16">2023年11月30日のアップデート調整内容</h3>
...
<tr>
<td>
<b class="a-bold">【強化内容】</b><br/><b class="a-bold">・インクの消費量量を約15%軽減しました。</b>
</td>
</tr>
<tr>
...
<td>
<b class="a-bold">【強化内容】</b><br/>
<b class="a-bold">・ギアパワー「アクション強化」による、「ジャンプ中の射撃のブレを抑える（地上での射撃のブレに近づける）効果」を、少ないギアパワーの数でも発揮されやすくしました。</b>
<br/>　‐最大まで「アクション強化」のギアパワーを装着している場合の効果はこれまでと変わりないよ。</td>
</tr>
<tr>
...
<h3 class="a-header--3" id="hm_18">2023年7月27日(木)のアップデート調整内容</h3>
<h4 class="a-header--4" id="hs_7">サブの調整内容</h4>
<table class="a-table a-table" style="">
<tr>
...
<h2 class="a-header--2" id="hl_8">S-BLAST92の元ネタ</h2>
<h3 class="a-header--3" id="hm_19">スーパーファミコンの周辺機器「スーパースコープ」</h3>
<p class="a-paragraph">S-BLAST92の元ネタは、スーパーファミコンの周辺機器「スーパースコープ」だ。元ネタのスーパースコープはS-BLAST92よりも銃身が細身ですが、見た目はほぼ変わりないよ。</p>
<p class="a-paragraph">なおスーパースコープは、大乱闘スマッシュブラザーズSPECIALのアイテムとしても出演している。</p>
<table class="a-table a-table" style="">
<tr>
...
<p class="a-paragraph"><a class="a-btn" href="#"><span>▶︎スマブラSPのアイテム一覧を見る</span></a></p>
