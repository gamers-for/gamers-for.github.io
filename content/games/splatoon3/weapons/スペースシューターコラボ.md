...
<h2>スペースシューターコラボの評価と役割</h2>
<table>
<tr>
  <td rowspan="4" colspan="2" style="text-align:center;vertical-align:middle;width:40%">
    <img src="/gamers-for/images/games/splatoon3/weapons/annaki-splattershot-nova.png" alt="スペースシューターコラボ" loading="lazy" width="90" height="90" style="display:inline-block"><br>
    <strong style="font-size:1.1em">スペースシューターコラボ</strong>
  </td>
...
<h3>シューターのスペースシューターコラボ</h3>
<table>
<tr><th style="background:#e8f5e9;color:#2e7d32">強い点</th></tr>
<tr><td>
<b>○ シューターの安定した連射力で、塗りもキルもバランスよくこなせる</b><hr><b>○ スプラッシュボムでキルもクリアリングもこなせる。汎用性が高く、投げ得な場面が多い</b><hr><b>○ スミナガシートで相手の視界をカット。一方的に攻撃できる状況を作れる</b>
</td></tr>
